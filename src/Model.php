...
abstract class Model
{
    ...
    {
        return static::executeWithPool(function(PDO $connection) {
    ...
    {
        return static::executeWithPool(function(PDO $connection) use ($id) {
            $table = static::getTable();
    ...
    protected static function executeWithPool(callable $callback)
    {
        $poolName = static::getPoolName();
        $pool = Quarry::getPool($poolName);
